...
**Character:** Expressive lead with drive, vibrato, and Prophet-style BBD chorus.

| Knob | Parameter | Range |
|------|-----------|-------|
| knob1 | Decay | Envelope decay/release (short decay, longer release tail) |
| knob2 | Brightness | Filter cutoff + envelope depth |
| knob3 | Drive | Saturation + high-freq presence |
| knob4 | Chorus | BBD-style stereo chorus depth |

**Oscillators:** 2 detuned saws + square sub octave

**Notable:** Vibrato (5Hz), drive with presence (HP edge blend), resonance 2-5, BBD chorus (0.8Hz LFO, 7ms base delay, 90° stereo phase offset)
