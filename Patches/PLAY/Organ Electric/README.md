...
**Character:** Hammond-style jazz organ with percussion, tube drive, and rotary speaker.

| Knob | Parameter | Range |
|------|-----------|-------|
| knob1 | Percussion | Percussive 3rd harmonic attack + key click (0-0.1) |
| knob2 | Drawbars | Mellow to bright harmonic stack |
| knob3 | Drive | Tube overdrive saturation |
| knob4 | Rotary | Rotary speaker speed (slow/fast) |

**Oscillators:** 9 additive sine tonewheels (16' through 1')

**Notable:** Key click tied to knob1 (0-0.1), 3rd harmonic percussion, tube overdrive with EQ, rotary with separate horn/drum rotation
